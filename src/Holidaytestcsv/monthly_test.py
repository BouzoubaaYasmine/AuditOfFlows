...
if len(missing_months) > 0:
    ...
    for month in missing_months:
        ...
        # holiday falls within the missing month and print the names of the holidays
        holiday_dates = []
        for date in morocco_holidays[
                    date(year=month.year, month=month.month, day=1):date(year=month.year, month=month.month, day=30)]:
